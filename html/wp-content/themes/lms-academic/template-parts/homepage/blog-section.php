...
$blog_section_title = $lms_academic_options['blog_title'];
$blog_desc = $lms_academic_options['blog_desc'];
$blog_category = $lms_academic_options['blog_category'];
$content_length = '100';
if($blog_show) {
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="blog-wrap">
                                  ...
                                  <figcaption>
                                    ...
                                    <p><?php echo wp_kses_post(lms_academic_get_excerpt($recent_query->post->ID, $content_length)); ?></p>
